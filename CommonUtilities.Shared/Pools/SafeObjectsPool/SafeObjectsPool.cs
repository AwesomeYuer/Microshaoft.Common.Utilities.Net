/* 
 *  fork from:
 *  https://github.com/2881099/SafeObjectPool
 *  thanks.
*/
namespace Microshaoft
{
    ...
    public partial class SafeObjectsPool<T> : IDisposable {
		...
		public SafeObjectsPool(int poolsize, Func<T> createObject, Action<Object<T>> onGetObject = null) : this(new DefaultPolicy<T> { PoolSize = poolsize, CreateObject = createObject, OnGetObject = onGetObject }) {
		}
		/// <summary>
		/// 创建对象池
		/// </summary>
		/// <param name="policy">策略</param>
		public SafeObjectsPool(IPolicy<T> policy) {
			Policy = policy;
